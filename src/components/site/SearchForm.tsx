...
import { escapeCPF } from "@/util/escapeCPF"
import { useState } from "react"

type Props = {
    onSearchButton: string
    loading: boolean
}
...
export const SearchForm = ({ onSearchButton, loading }: Props) => {
    ...
    return (
        <div>
            ...
            ></input>
            <button
                className=" w-full p-3 mt-3 rounded-lg bg-blue-800 text-white text-4xl border-b-4
                 border-blue-600 active:border-0
                 disabled:opacity-20"
